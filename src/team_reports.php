				...
				<div class="tab-content" id="nav-tabContent">
				  ...
				  <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                    ...
                    <tbody>
                      ...
                      $sql = " SELECT DISTINCT A.TEAM,
                      (SELECT COUNT(*) FROM FF_REPORT2 X , FF_TEAM
                      WHERE    TEAM = A.TEAM AND ENTERD_BY = SNO) A5 , 
                      (SELECT COUNT(*) FROM FF_REPORT2 X , FF_TEAM
                      WHERE     X.SALES_CATAGORY = 'Future Sale' AND ENTERD_BY = SNO AND TEAM = A.TEAM) A1 ,
                      (SELECT COUNT(*) FROM FF_REPORT2 X , FF_TEAM
                      WHERE     X.SALES_CATAGORY = 'Closed Sale' AND ENTERD_BY = SNO AND TEAM = A.TEAM) A2 ,
                      (SELECT COUNT(*) FROM FF_REPORT2 X , FF_TEAM
                      WHERE     X.SALES_CATAGORY = 'Not Interested' AND ENTERD_BY = SNO AND TEAM = A.TEAM) A3 ,
                      (SELECT COUNT(*) FROM FF_REPORT2 X , FF_TEAM
                      WHERE    X.SALES_CATAGORY IS NULL AND ENTERD_BY = SNO AND TEAM = A.TEAM) A4 
                      FROM FF_REPORT2 , FF_TEAM A
